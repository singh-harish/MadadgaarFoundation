...
<body>
  ...
  <nav id="mainNav" class="navbar navbar-expand-lg navbar-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="index.html"><img src="images/m.jpg" alt="..." /> Madadgaar Foundation</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
          <li class="nav-item"><a class="nav-link" data-bs-toggle="modal" href="index.html#portfolioModal1">Donate</a></li>
          <li class="nav-item"><a class="nav-link" href="events.html">Events</a></li>
          <li class="nav-item"><a class="nav-link" href="drives.html">Drives</a></li>
          <li class="nav-item"><a class="nav-link" href="careers.html">Careers</a></li>
          <li class="nav-item"><a class="nav-link" href="index.html#team">About Us</a></li>
  ...
  <section class="page-section" id="about">
    <div class="container">
      <div class="text-center">
        <h2 class="section-heading text-uppercase">Upcoming Drives</h2>
      ...
      <ul class="timeline">
        <?php
              ...
              $lkd= $event['lkdlink'];
                    ...
                    <div class="container">
                      <a href="<?php echo $fb; ?>" class="btn" role="button"><i class="social-icon fab fa-facebook"></i></a>
                      <a href="<?php echo $tw; ?>" class="btn" role="button"><i class="social-icon fab fa-twitter"></i></a>
                      <a href="<?php echo $ins; ?>" class="btn" role="button"><i class="social-icon fab fa-instagram"></i></a>
                      <a href="<?php echo $lkd; ?>" class="btn" role="button"><i class="social-icon fab fa-linkedin-in"></i></a>
                    </div>
		                <a href="article.html" class="btn btn-dark btn-lg active mt-3" role="button" aria-pressed="true">Read More</a>
		              </div>
		            </div>
		          </li>
